...
description: Seria um idiofone percutido indiretamente, agitado e com forma recipiente
  (quando os objetos sonoros se entrechocam entre si e contra a parede de um recipiente,
  ou objetos não sonoros batem nas paredes de um recipiente sonoro, como uma cabaça
  seca com sementes). Sendo assim podemos classificá-lo como 112.13.
mimo_code: null
author: null
reviewer: Alice L. Satomi
source_url: http://150.165.254.38/labeet/contents/paginas/acervo-brazinst/copy_of_idiofones/maraca
...
audio_video_links:
- title: https://www.youtube.com/watch?v=zIRJWwJxpqI
  url: https://www.youtube.com/watch?v=zIRJWwJxpqI
references:
- 'Almeida, Renato. 1942. História da Música Brasileira. 2. ed. Rio de Janeiro: Briguiet'
- 'Camêu, Helza. 1979. Instrumentos musicais dos indígenas brasileiros: catálogo da
  exposição. Rio de Janeiro: Bilbioteca Nacional; Funarte.'
- 'Disponível em: <https://www.youtube.com/watch?v=zIRJWwJxpqI>. Acesso em 08 jul
  2019'
- Gabriel da Rosa Seixas
- _____________________________________________
- ¹ Disponível em <https://jairantinguiboto.wordpress.com/conheca-a-aldeia-tingui-boto/artesanato/>
...
> Seria um idiofone percutido indiretamente, agitado e com forma recipiente (quando os objetos sonoros se entrechocam entre si e contra a parede de um recipiente, ou objetos não sonoros batem nas paredes de um recipiente sonoro, como uma cabaça seca com sementes). Sendo assim podemos classificá-lo como 112.13.
...
¹ Disponível em <https://jairantinguiboto.wordpress.com/conheca-a-aldeia-tingui-boto/artesanato/> Acesso em 13 jun 2016
