...
family: idiofones
subtitle: null
description: É um dentre os vários chocalhos globulares indígenas (ver Maracá). Seria
  um idiofone percutido indiretamente, agitado e com forma recipiente (quando os objetos
  sonoros se entrechocam contra a parede de um recipiente). Dessa forma, é classificado
  como 112.13.
mimo_code: null
author: null
reviewer: Alice L. Satomi
source_url: http://150.165.254.38/labeet/contents/paginas/acervo-brazinst/copy_of_idiofones/nhon-kon-ti
...
Helza Camêu (1979:13) registra o Nhon-kon-ti e afirma que em sua superfície, existem desenhos incisos. Além disso, há cobertura parcial de penas negras de mutum e vermelhas de arara, e ainda, pingentes de miçangas pretas e amarelas presas a um coco, terminados com penas de arara. “Fechando o instrumento, na parte oposta ao punho, além de perfurações, há uma cercadura de penas de mutum.” O instrumento tem função de marcação rítmica nos cantos e nas danças.

O exemplar registrado por Helza Camêu, faz parte da Coleção Terence Turner de 1963, dos índios GOROTIRE (grupo KAYAPÓ setentrional). Região do Rio Fresco no estado do Pará. A área cultural abrange o Tocantins - Xingu.
...
Turner, T. Nothern Cayapó music and its social and cerimonial context. (comunicação ao M.N. do RJ).
