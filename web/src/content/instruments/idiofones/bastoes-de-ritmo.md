...
family: idiofones
subtitle: null
description: Também chamado de Takapú, Karutana ou Wagrana, por Renato Almeida (1942:39).
  Seria um idiofone, percutido diretamente, em forma de bastão agrupado, tendo dois
  ou mais bastões sendo assim, classificado como 111.232.
mimo_code: null
author: null
reviewer: Alice L. Satomi
source_url: http://150.165.254.38/labeet/contents/paginas/acervo-brazinst/copy_of_idiofones/bastoes-de-ritmo
...
audio_video_links: []
references:
- O bastão rítmico também tem papel considerado no meio religioso, sendo usado em
  alguns rituais. Era um instrumento muito importante e relevante, tanto que ficava
  guardado na barraca sagrada com outros objetos litúrgicos, segundo Renato Almeida
  (1942:36).
- Ele diz ainda que em alguns casos, os bastões podem ser acompanhados de maracás
  na parte superior, como por exemplo os Uarangá dos Ipurucatá, feitos de um só colmo
  de taquara.
...
¹ Disponível em: <http://www.maimuseu.com.br/#!musicais/v076o> Acesso em: 22 jun 2016
