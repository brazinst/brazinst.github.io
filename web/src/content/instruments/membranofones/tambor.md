...
subtitle: null
description: Designação genérica para diversos instrumentos membranofônicos presentes
  no Brasil. Trata-se de um membranofone percutido diretamente, cilíndrico e fechado
  (2.1.1.2.1.1.2).
mimo_code: 2.1.1.2.1.1.2
author: Gabriel da Rosa Seixas
reviewer: Alice L. Satomi
source_url: http://150.165.254.38/labeet/contents/paginas/acervo-brazinst/copy_of_membranofones/tambor
...
audio_video_links: []
references:
- 'Guerra Peixe, César. 1966. Os cabocolinhos do Recife. In: Revista Brasileira do
  Folclore. 15/6: 135-58.'
- 'Madureira, Antônio José. 1980. Iniciação à música do Nordeste: através dos seus
